...
// const { findUbicacionesDB } = require("../adminIndex.js")
...
const findRegistrosActivosDB = async (tenant, usuario) => {
  ...
  const { Modelo } = adminModelInit(sequelize)
...
// 2. Renombrar archivo según feature (ej: clienteController.js)
...
// 10. Si es GENERAL, actualizar adminIndex.js para re-exportar